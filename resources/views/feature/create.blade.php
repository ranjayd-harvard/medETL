        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Add a new feature to charity: {{ $charity->charity_name }} </div>
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="/charitys/{{$charity->id}}/feature">
                            {{ csrf_field() }}
